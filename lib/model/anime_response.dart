class AnimeResponse {
  ...
  AnimeResponse({this.data, this.meta, this.links});
...
class DimensionsTwo {
  ...
  DimensionsTwo({this.tiny, this.large, this.small});

  DimensionsTwo.fromJson(Map<String, dynamic> json) {
    tiny = json['tiny'] != null ? new Tiny.fromJson(json['tiny']) : null;
    large = json['large'] != null ? new Tiny.fromJson(json['large']) : null;
    small = json['small'] != null ? new Tiny.fromJson(json['small']) : null;
  }
...
class LinksTwo {
  ...
  LinksTwo({this.self, this.related});
...
class MetaTwo {
  ...
  MetaTwo.fromJson(Map<String, dynamic> json) {
    count = json['count'];
  }
...
class LinksThree {
  ...
  LinksThree({this.first, this.next, this.last});

  LinksThree.fromJson(Map<String, dynamic> json) {
    first = json['first'];
    next = json['next'];
    last = json['last'];
  }
